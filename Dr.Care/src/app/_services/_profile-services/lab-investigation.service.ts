...
export class LabInvestigationService {
    ...
    constructor(public user: PersonalDataService) {
        this.labInvestigations = [
            ...
            patient: this.user.getById(1),
            notes: '4-One Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat, iste, architecto'},
            {id: 3, name: 'x-ray 2', labName: 'lab 2', date: '2019-02-01', type: 'x-ray', patientId: 2,
            patient: this.user.getById(2),
            notes: '2-One Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat, iste, architecto'},
            {id: 4, name: 'test 2', labName: 'lab 2', date: '2019-02-01' , type: 'test', patientId: 2,
            patient: this.user.getById(2),
            notes: '2-One Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat, iste, architecto'},
            {id: 5, name: 'x-ray 3', labName: 'lab 3', date: '2019-03-01', type: 'x-ray', patientId: 2,
            patient: this.user.getById(2),
            notes: '3-One Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat, iste, architecto'},
            {id: 6, name: 'test 3', labName: 'lab 3', date: '2019-03-01', type: 'test', patientId: 3,
            patient: this.user.getById(3),
            notes: '3-One Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat, iste, architecto'},
            {id: 7, name: 'x-ray 4', labName: 'lab 4', date: '2019-04-01', type: 'x-ray', patientId: 3,
            patient: this.user.getById(3),
            notes: '4-One Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat, iste, architecto'},
            {id: 7, name: 'x-ray 4', labName: 'lab 4', date: '2019-04-01', type: 'x-ray', patientId: 3,
            patient: this.user.getById(3),
            notes: '4-One Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat, iste, architecto'},
            {id: 8, name: 'test 4', labName: 'lab 4', date: '2019-04-01', type: 'test', patientId: 4,
            patient: this.user.getById(4),
            notes: '4-One Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat, iste, architecto'},
            {id: 3, name: 'x-ray 2', labName: 'lab 2', date: '2019-02-01', type: 'x-ray', patientId: 4,
            patient: this.user.getById(4),
            notes: '2-One Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat, iste, architecto'},
        ];
    }
